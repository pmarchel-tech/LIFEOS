              ...
              <div className="space-y-2.5">
                {updatesList.map((item) => {
                  ...
                  return (
                    <div
                      key={item.id}
                      className="p-3.5 rounded-xl bg-white dark:bg-neutral-900/60 border border-slate-200 dark:border-neutral-800/80 hover:border-slate-300 dark:hover:border-neutral-700 transition space-y-2 group/hist"
                    >
                        ...
                        {!isEditingThis && (
                          <div className="flex items-center gap-1 opacity-80 group-hover/hist:opacity-100 transition">
                            <button
                              ...
                              className="px-2 py-1 rounded hover:bg-slate-100 dark:hover:bg-neutral-800 text-slate-500 hover:text-blue-600 dark:hover:text-blue-400 text-[11px] font-semibold flex items-center gap-1 transition cursor-pointer"
                              title="Edit update ini"
                            >
                        ...
                        <div className="space-y-2 pt-1">
                          ...
                          <div className="flex justify-end items-center gap-2">
                            ...
                            <button
                              ...
                              className="px-3 py-1 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-xs font-bold transition flex items-center gap-1.5 cursor-pointer"
